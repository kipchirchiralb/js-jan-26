...
function calculateGradesList(list) {
...
// test data (not conflicting with lecturer code)
const myStudents = [
    { name: "Alice", scores: [80, 90, 70] },
    { name: "Bob", scores: [60, 50, 65] },
    { name: "Charlie", scores: [40, 30, 50] }
];

console.log(calculateGradesList(myStudents));